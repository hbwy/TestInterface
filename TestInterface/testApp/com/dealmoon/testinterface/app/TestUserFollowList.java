...
/**
 * @author: WY
 * @data:2015年4月13日 下午2:50:50
 * @description: UserFollowList 本人关注的用户的列表 不需要登录
 */
public class TestUserFollowList {
	...
	public static void init() {
		...
		reqJsons = (List<String>) reqData.get("userfollowlist");
	...
	public void testCodeZero() {
		...
		Assert.assertEquals("Error:The result code id not 0", 0, code);
	}
